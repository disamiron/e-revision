...
export const mainTexts = {
  ...
  aboutAppText:
    'E-Revision - это мобильное приложение, созданное для эффективной и быстрой инвентаризации товаров в магазинах и на складе. Идеально подходит для предпринимателей всех масштабов. Приложение обеспечивает надежный контроль и управление товарными остатками, позволяя вам сосредоточиться на развитии вашего бизнеса.',
