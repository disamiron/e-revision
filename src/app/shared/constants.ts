...
export const mainTexts = {
  ...
  aboutAppText:
    'E-Revision - мобильное приложение для эффективного и быстрого проведения ревизии товаров в магазинах. Оно разработано специально для предпринимателей, открывших магазин Fix Price по франшизе, и поможет вам легко контролировать и управлять товарными остатками.',
...
export const numberTexts = [
  {
    num: 'x100',
    description: 'Описание цифры в 1 строку',
  },
  {
    num: 'x100',
    description: 'Описание цифры в 1 строку',
